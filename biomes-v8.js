...
/* Danger is geographic only; combat heat/directors handle time/run escalation. This keeps every coordinate deterministic. */
dangerAt=function(x,y){return Math.max(0,Math.min(5,Math.floor(Math.hypot(x,y)/1250)))};
