...
function aaa6DrawCapitalIdentity(e){
  ...
  if(cls==='siege'){
    ...
    const shield=e.p2Systems?.shield?.alive;ctx.strokeStyle=shield?'#8fe8ff':'#46677d';ctx.globalAlpha=shield?0.85:0.35;ctx.shadowColor='#8fe8ff';ctx.shadowBlur=shield?14:0;ctx.beginPath();
